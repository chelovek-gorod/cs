...
class TestButton extends Container {
    constructor(title, subtitle, description, clickAction = null, parent = null, isAvailable = true, x, y) {
        super()
        ...
        if (this.clickAction) {
            ...
            btn.on('pointerup', this.clickAction, this.parentAction)
        }
    }
}
